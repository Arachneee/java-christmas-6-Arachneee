...
class BadgeTest {
    ...
    @DisplayName("혜택금액이 20000원 이상이면 산타등급이다.")
    @ParameterizedTest
    ...
    @DisplayName("혜택금액이 20000원 미만 10000원 이상이면 트리등급이다.")
    @ParameterizedTest
    ...
    @DisplayName("혜택금액이 10000원 미만 5000원 이상이면 별등급이다.")
    @ParameterizedTest
    ...
    @DisplayName("혜택금액이 5000원 미만이면 등급이 없다.")
    @ParameterizedTest
